...
public class MyLibraryTest extends TestCase {
	...
	public void setup() {
		//create objects - local by default
		// so make them fields of the test class
		// unfortunately, they are local vars...need to make them fields of TEST class
		// turn local var to field, highlight declare...."Convert local vars to fields" ( alt, t, b )
		b1 = new Book("Book1");
		b2 = new Book("Book2");
		p1 = new Person();
		p2 = new Person();
	...
	public void testCheckout() {
		...
		assertTrue("Book did not check out correctlly", 
				ml.checkOut(b1,p1));
		...
		// setup to reset previous test data
		setup();
